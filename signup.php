        ...
        <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="w-full max-w-md space-y-8">
                <div>
                    ...
                    <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Sign Up Your
                        Account!
                    </h2>
                </div>
                <form class="mt-8 space-y-6" action="#" method="POST">
                    ...
                    <div class="-space-y-px rounded-md shadow-sm">
                        <div class='p-2'>
                            <label class='text-lg font-bold'>First Name</label>
                        ...
                        <div class='p-2'>
                            <label class='text-lg font-bold'>Last Name</label>
                ...
                <div class="text-sm">
                    <a href="index.php"
                        class="font-bold text-indigo-600 hover:text-indigo-500 flex justify-center text-lg">
                        To Login Page!
                    </a>
                </div>
            </div>
