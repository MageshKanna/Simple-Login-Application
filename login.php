...
<body>
    ...
    <div class="cont p-3 d-flex align-items-center justify-content-center">
        <div class="text-center p-2 d-flex justify-content-center">
            <form method="post" class="form-group p-2">
                <h3 class="p-2 font-weight-bold">Please Sign In To Your Account!</h3>
                <div class="dropdown-divider dd"></div>
                <div class="status_info">
                </div>
                <div class="d-flex flex-column justify-content-right mb-4">
                    <label for="email" class='text-left font-weight-bold'>
                        Email
                    </label>
                    <input type="email" id="html" name="email" class="form-control mb-2"
                        placeholder="Email Goes Here...">
                </div>
                <div class="d-flex flex-column justify-content-right mb-4">
                    <label for="password" class='text-left font-weight-bold'>
                        Password
                    </label>
                    <input type="password" id="password" name="password" class="form-control mb-4"
                        placeholder="Password Goes Here...">
                </div>
                <button class="btn btn-primary w-50 m-2" formaction="../Includes/login.inc.php" name="submit"
                    type="submit">SignIn</button>
                <h5 class='m-2 font-weight-bold'>OR</h5>
                <div class="m-2">
                    <a href="signup.php" class='text-center h5 text-primary font-weight-bold'>
                        Create your account➜
                    </a>
                </div>
            </form>
